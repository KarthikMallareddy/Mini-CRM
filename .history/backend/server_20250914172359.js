...
// Test customer creation route (for debugging)
app.post("/api/test/customer", async (req, res) => {
  try {
    console.log("Test customer creation - Headers:", req.headers);
    console.log("Test customer creation - Body:", req.body);
    res.json({ 
    ...
    console.error("Test customer error:", err);
